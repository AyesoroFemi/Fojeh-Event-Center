    ...
    template: `
     <div>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active" style="background-image:linear-gradient(rgba(0,0,0, 0.5), rgba(0,0,0,0.5)), url(./img/emma.jpg);">
          ...
          <div class="carousel-item" style="background-image: linear-gradient(rgba(0,0,0, 0.5), rgba(0,0,0,0.5)), url(./img/femi2.jpg);">
          ...
          <div class="carousel-item" style="background-image: linear-gradient(rgba(0,0,0, 0.5), rgba(0,0,0,0.5)),url(./img/emma2.jpg);">
